 ...
 * @author usuario
 */
public class Frm_MntAdmSubCat extends javax.swing.JInternalFrame {

    /**
     * Creates new form Frm_MntAdmSubCat
     */
    public Frm_MntAdmSubCat() {
        initComponents();
        CargarC();
        BloquearTabla();
        ListarSubcategorias();
    ...
    public void ListarSubcategorias(){
        ...
        ArrayList<SubCategoria> lc = sbcdao.listarSubCategoria();
        listaidSubCategoria = new int[lc.size()];
        String col[] = {"Nombre","Categoria"};
        ...
        for (int i = 0; i < lc.size(); i++) {
            ...
            row[1] = lc.get(i).getNomCategoria();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Mantenimiento SubCategorias");
